CREATE OR REPLACE PROCEDURE test_smtp AS 
  ...
  k_port            CONSTANT INTEGER       := 587; --443
  k_wallet_path     CONSTANT VARCHAR2(100) := 'file:/u00/app/oracle/product/12.2.0/gfafdgsfdg/data/wallet';
  k_wallet_password CONSTANT VARCHAR2(100) := 'aHiaHococ.386';
  k_domain          CONSTANT VARCHAR2(100) := 'dfadas.fadadsf.com';
